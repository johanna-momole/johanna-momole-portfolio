...
import { MailIcon, ArrowRightIcon, FileTextIcon } from "lucide-react"
  ...
  return (
    <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-8 lg:px-16">
      ...
      <section
        ...
        className="pb-14 pt-28 md:pb-20 md:pt-36"
      >
      ...
      {/* ── 2. PRIMARY CONTACT PANEL ─────────────────────────────────────────── */}
      <section aria-labelledby="contact-email-heading" className="py-14 md:py-18">
        <Reveal>
          <div className="max-w-2xl">
            <GlassPanel variant="dark" className="p-7 sm:p-9">

              {/* Small decorative biological motif */}
              <div
              ...
              */}
              ...
              <p className="mt-5 text-xs text-white/28">
                Suggested subject: &ldquo;Portfolio inquiry&rdquo; &mdash; feel free to use your own.
              </p>
      ...
      <section aria-labelledby="contact-links-heading" className="py-14 md:py-18">
        <Reveal>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {/* LinkedIn — only shown when URL is confirmed */}
          {hasLinkedIn && (
            <Reveal delay={0.07}>
              <a
                href={linkedin}
          ...
          {/* GitHub — only shown when URL is confirmed */}
          {hasGitHub && (
            <Reveal delay={0.10}>
              <a
                href={github}
        ...
        {/* Note when links are unavailable */}
      ...
      {/* ── 4. AREAS OF INTEREST ─────────────────────────────────────────────── */}
      <section aria-labelledby="contact-interests-heading" className="py-14 md:py-18">
        <Reveal>
          <p className="mb-2 text-[10px] font-medium tracking-[0.18em] uppercase text-aqua/55">
            Open to conversations about
          </p>
          <h2
            id="contact-interests-heading"
      ...
      {/* ── 5. LOCATION AND COLLABORATION ───────────────────────────────────── */}
      <section
        aria-labelledby="contact-location-heading"
        className="py-14 md:py-18"
      >
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr] lg:gap-12">

          <Reveal delay={0.04}>
            <div>
              <h2
                id="contact-location-heading"
                className="mb-3 text-[10px] font-medium tracking-[0.18em] uppercase text-blush/55"
              >
                Location
              </h2>
