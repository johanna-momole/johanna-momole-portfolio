// Single source of truth for professional history, used by both
// /experience (editorial) and /resume (utilitarian) pages.
...
export type ExperienceRole = {
  ...
  location: string
  period: string | null
  type: "employment" | "research" | "education"
  domain: string
...
export const experienceRoles: ExperienceRole[] = [
  {
    id: "itb",
    title: "Bioinformatics Research Coordinator",
    ...
    chapterEra: "Research",
    summary:
      "Coordinated bioinformatics research at ITB, working on metagenomics and metatranscriptomics projects that characterized microbial communities from environmental and clinical samples. Applied a range of computational tools to process, align, and annotate sequencing data, building the technical foundation that would later inform more applied analytical work in healthcare settings.",
    highlights: [
      "Coordinated metagenomics and metatranscriptomics research workflows",
      "Applied Mothur for amplicon-based microbiome analysis",
      "Used TopHat and Cufflinks for RNA-seq alignment and transcript assembly",
      "Developed analysis scripts using Biopython and R",
      "Contributed to research coordination across multiple study workflows",
    ],
    metrics: null,
...
// Reverse chronological order for the Resume page
export const resumeRoles: ExperienceRole[] = [...experienceRoles].reverse()
...
export const professionalSummary =
  "Biomedical informatics professional with a background spanning bioinformatics research, diagnostic laboratory operations, and hospital network strategy. Graduate training at the University of Pennsylvania (MBI, GPA 3.81) provided rigorous methods in real-world evidence, pharmacovigilance, and clinical data science. Analytical work has supported measurable outcomes in healthcare operations, and graduate projects span FDA FAERS signal detection, OMOP CDM cohort design, and public health machine learning. Focused on producing evidence that is rigorous, interpretable, and actionable."
...
export const capabilities = [
  ...
  },
  {
    ...
    description:
      "Molecular laboratory operations, metagenomics and metatranscriptomics coordination, and bioinformatics pipeline development.",
  },
]
